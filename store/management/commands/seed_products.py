...
PRODUCTS = [
    dict(ref="MK-01-NC", name="Perpetual Noir", tagline="Master Chronograph", category="Men", price=2250000,
    ...
    dict(ref="MK-02-LG", name="Lumière Grande", tagline="Tourbillon Perpetuel", category="Men", price=5850000,
    ...
    dict(ref="MK-03-EQ", name="Équinoxe", tagline="Moonphase Automatique", category="Men", price=2780000,
    ...
    dict(ref="MK-04-OD", name="Obsidian Diver", tagline="Professional Diver 500M", category="Men", price=1690000,
    ...
    dict(ref="MK-05-RA", name="Rose Aurora", tagline="Ladies Automatique", category="Women", price=1950000,
    ...
    dict(ref="MK-06-DR", name="Diamant Rosé", tagline="Diamond Chronograph", category="Women", price=3420000,
    ...
    dict(ref="MK-07-PD", name="Perle Dorée", tagline="Mesh Bracelet Diamant", category="Women", price=2890000,
    ...
    dict(ref="MK-08-EB", name="Étoile Blanche", tagline="Slim Automatique", category="Women", price=1850000,
