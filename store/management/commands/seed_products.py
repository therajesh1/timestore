...
PRODUCTS = [
    dict(ref="MK-01-NC", name="Perpetual Noir", category="Wrist Watch", price=2250000,
    ...
    dict(ref="MK-02-LG", name="Lumière Grande", category="Wrist Watch", price=5850000,
    ...
    dict(ref="MK-03-EQ", name="Équinoxe", category="Wrist Watch", price=2780000,
    ...
    dict(ref="MK-04-OD", name="Obsidian Diver", category="Wrist Watch", price=1690000,
    ...
    dict(ref="MK-05-RA", name="Rose Aurora", category="Wrist Watch", price=1950000,
    ...
    dict(ref="MK-06-DR", name="Diamant Rosé", category="Wrist Watch", price=3420000,
    ...
    dict(ref="MK-07-PD", name="Perle Dorée", category="Wrist Watch", price=2890000,
    ...
    dict(ref="MK-08-EB", name="Étoile Blanche", category="Wrist Watch", price=1850000,
